...
- **AC-4 (end-to-end):** Given AC-1..AC-3, When the XOB-031 E2E suite runs, Then the 8 previously-failing overlay-mount flows pass and the overlay reaches the real engine via `useTransport()`.
