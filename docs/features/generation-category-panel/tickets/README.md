...
|---|---|---|---|---|---|
| GCP-001 | Done | - | Bounded Generation Category Panel | overlay/ui | - |
| GCP-002 | Done | [INT] | Rail Integration Regression | overlay/browser tests | GCP-001 |
...
- 2026-06-28: GCP-002 integration ticket approved by RGB validation after tightened invariants for rejection, ordering, and warning badges.
